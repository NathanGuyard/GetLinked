...
const APIMiddleware = (store) => (next) => (action) => {
  if (action.type === 'FETCH_ARTISTS') {
    axios.get('http://ec2-18-212-19-22.compute-1.amazonaws.com/api/v1/users/')
      .then((response) => {
    ...
    const artistsList = axios.get('http://ec2-18-212-19-22.compute-1.amazonaws.com/api/v1/users/');
    const eventsList = axios.get('http://ec2-18-212-19-22.compute-1.amazonaws.com/api/v1/events/');
    ...
    axios.get('http://ec2-18-212-19-22.compute-1.amazonaws.com/api/v1/events/')
      .then((response) => {
        store.dispatch({
          type: 'LOAD_EVENTS',
